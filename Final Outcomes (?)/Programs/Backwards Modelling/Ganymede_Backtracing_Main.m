    % Modelling particle impacts on Ganymede's surface!
...
numsteps = 5000;                                     % doesnt tend to need above this number
sim_size = 5 * R_G;
...
[init_r, init_v_vectors, N_total, particle_traits, elements] = Spherical_Starting_States(...
    -90:5:90, 0:5:359, 0:10:80, 0:60:359, init_energies, m, q, elements, R_G);
...
Particle_Flux_2D(r_cell, 1, numsteps, 'all', 100, sim_size, init_energies, elements(1), ...
    timestep, start, "Ganymede", update_gap);
Particle_Flux_Iso(r_cell, 1, numsteps, 100, sim_size, init_energies, elements(1), ...
    timestep, start, "Ganymede", [5,10], update_gap);