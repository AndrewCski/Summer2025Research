    % Modelling Io dust passing by Europa!
...
[init_r, init_v_vectors, N_total, particle_traits] = Io_Dust_Starting_States([30,30], ...
    [-1.25*R_E,1.25*R_E], [-1.25*R_E,1.25*R_E], -3*R_E, 0, 0, 100000, 1000, 10e-9, 2500);
...
forward_particle_start_accessibilities(init_r, escaped, 0, particle_traits(1, 1)./ ...
    particle_traits(1, 2), "Europa")
forward_particle_impact_accessibilities(impact_coords, 5, particle_traits(1, 1)./ ...
    particle_traits(1, 2), "Europa", elements, "q/m", true, false)
