...
[init_r, init_v_vectors, N_total, particle_traits] = Io_Dust_Starting_States(...
    [10,10], [-1.25*R_G,1.25*R_G], [-1.25*R_G,1.25*R_G], -3*R_G, 200000, 5000, 10e-9, 2500);
...
B0_vec = [-15 * 10 ^-9; 24 * 10 ^-9; 0]; % seems to oscillate, idk about the amplitude rn... 
...
forward_particle_start_accessibilities(init_r, escaped, 0, q_over_m, "Ganymede")
% forward_particle_start_accessibilities(init_r, escaped, [2,2], q_over_m, "Ganymede")
forward_particle_impact_accessibilities(impact_coords, 5, q_over_m, "Ganymede")