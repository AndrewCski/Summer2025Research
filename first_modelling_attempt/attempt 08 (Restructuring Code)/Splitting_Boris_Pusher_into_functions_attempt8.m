...
initial_velocities = [E_to_v_eV(1000, m), E_to_v_eV(10000, m), E_to_v_eV(100000, ...
    m), E_to_v_eV(1000000, m)];
...
[init_r, init_v_vectors, parts_per_E, N_total] = Spherical_Starting_States(90:-90:-90, ...
    0:90:359, 0, 0, initial_velocities);
...
for p_index = 1:N_total
    for u = 1:numsteps-1
        r_now = r(:,u,p_index);
        v_now = v(:,u,p_index);
        [r_new, v_new] = Relativistic_Boris(r_now,v_now,timestep,B_prim(:,u),E, m, q);
