...
[init_r, init_v_vectors, N_total, particle_traits] = Plume_Dust_Starting_States(0, ...
    0, 15, 3, 0:60:359, [100,1000], [100,1000], 10e-9:10e-9:30e-9, 2500);
...
numsteps = 250000;                                     % doesnt tend to need above this number
sim_size = 2 * R_E;
...
for p_index = 1:N_total
    ...
    for u = 1:numsteps-1
        ...
        [r_new, v_new] = new_relativistic_Boris(r_now, v_now, timestep, B_prim_now, ...
            1, case_id, particle_traits(p_index, 5), particle_traits(p_index, 4));
...
forward_particle_impact_accessibilities(impact_coords, 5, particle_traits(:, 4)./ ...
    particle_traits(:, 5), "Europa")